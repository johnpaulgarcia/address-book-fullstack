...
class AddContact extends React.Component{
	...
	createModal = () => {
		this.props.dispatch(create(false));
	}
	...
	submit = (e) => {
		...
		this.props.dispatch(addContact(data,this.props.user.token));
	}
						...
						<form onSubmit={this.submit} style={{width: '100%',backgroundColor: '#fff'}}>
						         <Grid container spacing={3} style={{padding: '10px'}}>
								   ...
								   <Grid item xs={12}>
						         	...
						         	<Grid item xs={12} sm={6}>
						         		<Button type="submit" style={{width: '100%'}} variant="contained" color="primary">CREATE</Button>
						         	</Grid>
